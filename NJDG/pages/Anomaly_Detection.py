...
# Use shared sidebar for consistent navigation
...
def load_data(cases_path="data/ISDMHack_Cases_students.csv",
              hearings_path="data/ISDMHack_Hear_students.csv"):
...
def run_dashboard():
    ...
    st.success("Done! Here are the first few anomalies:")
